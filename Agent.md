...
```mermaid
flowchart LR
  Duelist["Duelist"] --> D1["Take first contact"]
  Duelist --> D2["Create entry space"]
  Initiator["Initiator"] --> I1["Gather info"]
  Initiator --> I2["Force defenders off angles"]
  Controller["Controller"] --> C1["Block vision"]
  Controller --> C2["Control pace and zones"]
  Sentinel["Sentinel"] --> S1["Anchor sites"]
  Sentinel --> S2["Watch flank and punish pushes"]
```
